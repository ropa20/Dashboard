      ...
      <BrowserRouter>
        <Suspense fallback={<div />}>
          <Routes>
            ...
            <Route path="/auth/reset_password/:id" element={<ResetPasswordConfirmation />}></Route>
            <Route
              path="/login"
              element={
                <Main>
            ...
            <Route path="/vehicle" element={<Main><Vehicle /></Main>}></Route>

            <Route path="/vehicle/view_vehicle/:id" element={<Main><ViewVehicle /></Main>}></Route>

            <Route path="/edit_vehicle/:id" element={<Main><AddVehicle /></Main>}></Route>

            <Route path="/add_vehicle" element={<Main><AddVehicle /></Main>}></Route>
            <Route path="/hub" element={<Main><Hub /></Main>}></Route>

            <Route path="/view_hub/:id" element={<Main><ViewHub /></Main>}></Route>

            <Route path="/edit_hub/:id" element={<Main><AddHub /></Main>}></Route>

            <Route path="/add_hub" element={<Main><AddHub /></Main>}></Route>
            <Route path="/outsource" element={<Main><Outsource /></Main>}></Route>

            <Route path="/view_outsource/:id" element={<Main><ViewOutsource /></Main>}></Route>

            <Route path="/edit_outsource/:id" element={<Main><AddOutsource /></Main>}></Route>

            <Route path="/add_outsource" element={<Main><AddOutsource /></Main>}></Route>
            <Route path="/payout" element={<Main><Payout /></Main>}></Route>

            <Route path="/view_payout/:id" element={<Main><ViewPayout /></Main>}></Route>

            <Route path="/edit_payout/:id" element={<Main><AddPayout /></Main>}></Route>

            <Route path="/add_payout" element={<Main><AddPayout /></Main>}></Route>
            <Route path="/driver" element={<Main><Driver /></Main>}></Route>

            <Route path="/view_driver/:id" element={<Main><ViewDriver /></Main>}></Route>

            <Route path="/edit_driver/:id" element={<Main><AddDriver /></Main>}></Route>

            <Route path="/add_driver" element={<Main><AddDriver /></Main>}></Route>
            <Route path="/booking" element={<Main><Booking /></Main>}></Route>

            <Route path="/view_booking/:id" element={<Main><ViewBooking /></Main>}></Route>

            <Route path="/edit_booking/:id" element={<Main><AddBooking /></Main>}></Route>

            <Route path="/add_booking" element={<Main><AddBooking /></Main>}></Route>
            <Route path="/checkin" element={<Main><Checkin /></Main>}></Route>
            <Route path="/profile" element={<Main><Profile /></Main>}></Route>

            <Route path="/view_checkin/:id" element={<Main><ViewCheckin /></Main>}></Route>
            <Route path="/city" element={<Main><CityScreen/></Main>}></Route>
