...
export default function Profile() {
  ...
  const inputFields: IAddValues[] = [
    ...
    // { label: "Organization", key: "organization.name", isNested: true, type: "store" },
    // { label: "Store", key: "store.name", isNested: true, type: "store" },
    // { label: "Store type", key: "organization.type", isNested: true, type: "store" },
